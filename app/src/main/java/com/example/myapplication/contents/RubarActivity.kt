...
import com.example.myapplication.databinding.ActivityRubarBinding
import com.example.myapplication.databinding.ActivityRunnerBinding
import com.example.myapplication.domain.RepresentProduct
import com.example.myapplication.domain.RubarProduct
...
class RubarActivity : AppCompatActivity() {

    private lateinit var binding: ActivityRubarBinding
    var rubarProduct = RubarProduct()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_rubar)
    ...
    fun product_data(rubarProduct: RubarProduct) {
        val call = RetrofitBuilderDto.api.getProductResponse(rubarProduct)
        call.enqueue(object : Callback<List<RubarProduct>> {
            override fun onResponse(call: Call<List<RubarProduct>>, response: Response<List<RubarProduct>>) {
            ...
            override fun onFailure(call: Call<List<RubarProduct>>, t: Throwable) {
