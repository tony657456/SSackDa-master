...
import com.example.myapplication.databinding.ActivityGypsumBinding
import com.example.myapplication.databinding.ActivityMainBinding
import com.example.myapplication.domain.GypsumProduct
...
class GypsumActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityGypsumBinding
    var gypsumProduct = GypsumProduct()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_gypsum)
    ...
    fun product_data(gypsumProduct: GypsumProduct) {
        val call = RetrofitBuilderDto.api.getProductResponse(gypsumProduct)
        call.enqueue(object : Callback<List<GypsumProduct>> {
            override fun onResponse(call: Call<List<GypsumProduct>>, response: Response<List<GypsumProduct>>) {
            ...
            override fun onFailure(call: Call<List<GypsumProduct>>, t: Throwable) {
