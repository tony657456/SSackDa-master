...
import com.example.myapplication.databinding.ActivityBangdekBinding
import com.example.myapplication.databinding.ActivityMainBinding
import com.example.myapplication.domain.BangdekProduct
...
class BangdekActivity : AppCompatActivity() {

    private lateinit var binding: ActivityBangdekBinding
    var bangdekProduct = BangdekProduct()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_bangdek)
    ...
    fun product_data(bangdekProduct: BangdekProduct) {
        val call = RetrofitBuilderDto.api.getProductResponse(bangdekProduct)
        call.enqueue(object : Callback<List<BangdekProduct>> {
            override fun onResponse(call: Call<List<BangdekProduct>>, response: Response<List<BangdekProduct>>) {
            ...
            override fun onFailure(call: Call<List<BangdekProduct>>, t: Throwable) {
