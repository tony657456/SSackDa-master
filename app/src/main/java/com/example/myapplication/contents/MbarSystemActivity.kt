...
import com.example.myapplication.databinding.ActivityMbarSystemBinding
import com.example.myapplication.domain.MbarSystemProduct
...
class MbarSystemActivity : AppCompatActivity() {

    private lateinit var binding: ActivityMbarSystemBinding
    var mbarSystemProduct = MbarSystemProduct()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_mbar_system)
        ...
        product_data(mbarSystemProduct)
    }
    ...
    fun product_data(mbarSystemProduct: MbarSystemProduct) {
        val call = RetrofitBuilderDto.api.getProductResponse(mbarSystemProduct)
        call.enqueue(object : Callback<List<MbarSystemProduct>> {
            override fun onResponse(call: Call<List<MbarSystemProduct>>, response: Response<List<MbarSystemProduct>>) {
            ...
            override fun onFailure(call: Call<List<MbarSystemProduct>>, t: Throwable) {
