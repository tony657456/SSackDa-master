...
import com.example.myapplication.databinding.ActivityEboardBinding
import com.example.myapplication.domain.DmcProduct
import com.example.myapplication.domain.EboardProduct
...
class EboardActivity : AppCompatActivity() {

    private lateinit var binding: ActivityEboardBinding
    var eboardProduct = EboardProduct();
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_eboard)
    ...
    fun product_data(eboardProduct: EboardProduct) {
        val call = RetrofitBuilderDto.api.getProductResponse(eboardProduct)
        call.enqueue(object : Callback<List<EboardProduct>> {
            override fun onResponse(call: Call<List<EboardProduct>>, response: Response<List<EboardProduct>>) {
            ...
            override fun onFailure(call: Call<List<EboardProduct>>, t: Throwable) {
