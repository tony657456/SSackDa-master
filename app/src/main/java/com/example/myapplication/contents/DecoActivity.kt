...
import com.example.myapplication.databinding.ActivityDecoBinding
import com.example.myapplication.databinding.ActivityMainBinding
import com.example.myapplication.domain.DecoProduct
...
class DecoActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityDecoBinding
    var decoProduct = DecoProduct()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_deco)
    ...
    fun product_data(decoProduct: DecoProduct) {
        val call = RetrofitBuilderDto.api.getProductResponse(decoProduct)
        call.enqueue(object : Callback<List<DecoProduct>> {
            override fun onResponse(call: Call<List<DecoProduct>>, response: Response<List<DecoProduct>>) {
            ...
            override fun onFailure(call: Call<List<DecoProduct>>, t: Throwable) {
