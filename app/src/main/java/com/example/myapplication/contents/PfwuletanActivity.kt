...
import com.example.myapplication.databinding.ActivityPfwuletanBinding
import com.example.myapplication.domain.PfwuletanProduct
...
class PfwuletanActivity: AppCompatActivity() {

    private lateinit var binding: ActivityPfwuletanBinding
    var pfwuletanProduct = PfwuletanProduct()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_pfwuletan)
    ...
    fun product_data(pfwuletanProduct: PfwuletanProduct) {
        val call = RetrofitBuilderDto.api.getProductResponse(pfwuletanProduct)
        call.enqueue(object : Callback<List<PfwuletanProduct>> {
            override fun onResponse(call: Call<List<PfwuletanProduct>>, response: Response<List<PfwuletanProduct>>) {
            ...
            override fun onFailure(call: Call<List<PfwuletanProduct>>, t: Throwable) {
