...
import com.example.myapplication.databinding.ActivityGlassBinding
import com.example.myapplication.databinding.ActivityMainBinding
import com.example.myapplication.domain.GlassProduct
...
class GlassActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_glass)
    ...
    fun product_data(glassProduct: GlassProduct) {
        val call = RetrofitBuilderDto.api.getProductResponse(glassProduct)
        call.enqueue(object : Callback<List<GlassProduct>> {
            override fun onResponse(call: Call<List<GlassProduct>>, response: Response<List<GlassProduct>>) {
            ...
            override fun onFailure(call: Call<List<GlassProduct>>, t: Throwable) {
