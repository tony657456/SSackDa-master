...
import com.example.myapplication.databinding.ActivityJipmulBinding
import com.example.myapplication.databinding.ActivityMainBinding
import com.example.myapplication.domain.JipmulProduct
...
class JipmulActivity : AppCompatActivity() {

    private lateinit var binding: ActivityJipmulBinding
    var jipmulProduct = JipmulProduct()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_jipmul)
    ...
    fun product_data(jipmulProduct: JipmulProduct) {
        val call = RetrofitBuilderDto.api.getProductResponse(jipmulProduct)
        call.enqueue(object : Callback<List<JipmulProduct>> {
            override fun onResponse(call: Call<List<JipmulProduct>>, response: Response<List<JipmulProduct>>) {
            ...
            override fun onFailure(call: Call<List<JipmulProduct>>, t: Throwable) {
