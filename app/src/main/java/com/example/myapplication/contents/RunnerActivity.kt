...
import com.example.myapplication.domain.RunnerProduct
...
class RunnerActivity : AppCompatActivity() {
    ...
    var runnerProduct = RunnerProduct()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_runner)
    ...
    fun product_data(runnerProduct: RunnerProduct) {
        val call = RetrofitBuilderDto.api.getProductResponse(runnerProduct)
        call.enqueue(object : Callback<List<RunnerProduct>> {
            override fun onResponse(call: Call<List<RunnerProduct>>, response: Response<List<RunnerProduct>>) {
            ...
            override fun onFailure(call: Call<List<RunnerProduct>>, t: Throwable) {
