...
import com.example.myapplication.databinding.ActivityMdfBinding
import com.example.myapplication.domain.MdfProduct
...
class MdfActivity : AppCompatActivity() {

    private lateinit var binding: ActivityMdfBinding
    var mdfProduct = MdfProduct()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_mdf)
    ...
    fun product_data(mdfProduct: MdfProduct) {
        val call = RetrofitBuilderDto.api.getProductResponse(mdfProduct)
        call.enqueue(object : Callback<List<MdfProduct>> {
            override fun onResponse(call: Call<List<MdfProduct>>, response: Response<List<MdfProduct>>) {
            ...
            override fun onFailure(call: Call<List<MdfProduct>>, t: Throwable) {
