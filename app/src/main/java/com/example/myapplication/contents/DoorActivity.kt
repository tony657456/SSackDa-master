...
import com.example.myapplication.domain.DoorProduct
...
class DoorActivity : AppCompatActivity() {
    ...
    fun product_data(doorProduct: DoorProduct) {
        val call = RetrofitBuilderDto.api.getProductResponse(doorProduct)
        call.enqueue(object : Callback<List<DoorProduct>> {
            override fun onResponse(call: Call<List<DoorProduct>>, response: Response<List<DoorProduct>>) {
            ...
            override fun onFailure(call: Call<List<DoorProduct>>, t: Throwable) {
