...
import com.example.myapplication.databinding.ActivityDarukiBinding
import com.example.myapplication.databinding.ActivityMainBinding
import com.example.myapplication.domain.DarukiProduct
...
class DarukiActivity : AppCompatActivity() {

    private lateinit var binding: ActivityDarukiBinding
    var darukiProduct = DarukiProduct()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_daruki)
    ...
    fun product_data(darukiProduct: DarukiProduct) {
        val call = RetrofitBuilderDto.api.getProductResponse(darukiProduct)
        call.enqueue(object : Callback<List<DarukiProduct>> {
            override fun onResponse(call: Call<List<DarukiProduct>>, response: Response<List<DarukiProduct>>) {
            ...
            override fun onFailure(call: Call<List<DarukiProduct>>, t: Throwable) {
