...
import com.example.myapplication.databinding.ActivityTaxBinding
import com.example.myapplication.domain.TaxProduct
...
class TaxActivity : AppCompatActivity() {
    ...
    fun product_data(taxProduct: TaxProduct) {
        val call = RetrofitBuilderDto.api.getProductResponse(taxProduct)
        call.enqueue(object : Callback<List<TaxProduct>> {
            override fun onResponse(call: Call<List<TaxProduct>>, response: Response<List<TaxProduct>>) {
            ...
            override fun onFailure(call: Call<List<TaxProduct>>, t: Throwable) {
