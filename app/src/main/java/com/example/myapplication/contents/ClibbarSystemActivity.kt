...
import com.example.myapplication.databinding.ActivityClibbarSystemBinding
import com.example.myapplication.domain.ClibbarSystemProduct
...
class ClibbarSystemActivity : AppCompatActivity() {

    private lateinit var binding: ActivityClibbarSystemBinding
    var clibbarSystemProduct = ClibbarSystemProduct()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_clibbar_system)
        ...
        product_data(clibbarSystemProduct)
    }
    ...
    fun product_data(clibbarSystemProduct: ClibbarSystemProduct) {
        val call = RetrofitBuilderDto.api.getProductResponse(clibbarSystemProduct)
        call.enqueue(object : Callback<List<ClibbarSystemProduct>> {
            override fun onResponse(call: Call<List<ClibbarSystemProduct>>, response: Response<List<ClibbarSystemProduct>>) {
            ...
            override fun onFailure(call: Call<List<ClibbarSystemProduct>>, t: Throwable) {
